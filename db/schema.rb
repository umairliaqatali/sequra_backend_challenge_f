...
ActiveRecord::Schema[7.0].define(version: 2023_12_27_133748) do
  ...
  create_table "monthly_fee_records", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["merchant_id", "record_month_date"], name: "index_unique_monthly_fee_records_on_merchant_and_date", unique: true
